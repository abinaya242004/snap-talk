...
const Header = ({ roomName, onlineUsersCount, roomAvatar, isGroup, isOnline, lastSeen }) => {
  ...
  return (
    <div className={`h-20 border-b border-[var(--border-color)] px-6 flex items-center justify-between flex-shrink-0 transition-all ${
      isGroup 
      ...
      <div className="flex items-center">
        {roomName && (
          <>
            {isGroup ? (
              <div className="p-[2px] rounded-full border-2 border-[var(--primary-accent)]/30 mr-4">
                <Avatar
                  src={roomAvatar}
                  alt={roomName}
                  size="xl"
      ...
      <div className="flex items-center space-x-6">
        ...
        <div className="flex items-center bg-[var(--bg-card)]/50 rounded-2xl px-4 py-2 border border-[var(--border-color)] group hover:bg-[var(--bg-card)] transition-all cursor-default">
          ...
          <Avatar 
            ...
            className="ring-2 ring-[var(--primary-accent)]/20 group-hover:ring-[var(--primary-accent)]/40 transition-all"
          />
        </div>
      </div>
    </div>
